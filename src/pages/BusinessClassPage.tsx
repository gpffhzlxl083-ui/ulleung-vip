...
import businessClassAmenity from "../assets/business-class/business-class-amenity.webp";
import businessClassPostcardDokdo from "../assets/business-class/business-class-postcard-dokdo.webp";
import businessClassPostcardPlains from "../assets/business-class/business-class-postcard-plains.webp";
import businessClassPostcardWave from "../assets/business-class/business-class-postcard-wave.webp";
import businessClassShip from "../assets/business-class/business-class-ship.webp";
import businessClassShipSunrise from "../assets/business-class/business-class-ship-sunrise.webp";
import businessClassTote from "../assets/business-class/business-class-tote.webp";
...
const BUSINESS_META: MetaRow[] = [
  { label: "class", value: "business (최고 등급)" },
  {
    label: "type",
    value:
      "일반석에 비해 쾌적하고 조용한 환경을\n제공하며 15°정도 시트를 기울일 수\n있는 장점이 있습니다",
  },
  {
    label: "seat",
    value: "seat A10 - F21",
...
const SLIDES: Slide[] = [
  {
    src: businessClassShip,
    title: "DOKDO SHIP",
    lead: "<오브, 울릉>의 독도 쾌속선은 안정적입니다",
    meta: [
      { label: "ferry name", value: "sunrise" },
      {
        label: "data",
        value: "소요 시간 : 1시간 20분\n최고 속도 : 76km\n승선 인원 : 442명",
        detail: "울릉 출발 : 08시20분\n독도 출발 : 10시30분",
  ...
  {
    src: businessClassShipSunrise,
    title: "BUSINESS",
    lead: "<오브, 울릉>의 좌석은 비즈니스입니다",
    objectPosition: "center",
    meta: BUSINESS_META,
  },
  {
    src: businessClassAmenity,
    title: "VIP GOODS",
    lead: "<오브, 울릉>은 프리미엄 굿즈를 제공합니다",
    meta: BUSINESS_META,
  },
  {
    src: businessClassTote,
    title: "VIP GOODS",
    lead: "<오브, 울릉>은 프리미엄 굿즈를 제공합니다",
    meta: BUSINESS_META,
  },
  {
    src: businessClassPostcardDokdo,
    title: "VIP GOODS",
    lead: "<오브, 울릉>은 프리미엄 굿즈를 제공합니다",
    meta: BUSINESS_META,
  },
  {
    src: businessClassPostcardPlains,
    title: "VIP GOODS",
    lead: "<오브, 울릉>은 프리미엄 굿즈를 제공합니다",
    meta: BUSINESS_META,
  },
  {
    src: businessClassPostcardWave,
    title: "VIP GOODS",
    lead: "<오브, 울릉>은 프리미엄 굿즈를 제공합니다",
    meta: BUSINESS_META,
  },
